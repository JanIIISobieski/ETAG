...
class PressureBuffer : public AbstractBuffer<uint8_t> {
    public:
        PressureBuffer(volatile uint8_t** buffers, size_t num_buffers, size_t buffer_length, uint8_t id, Tag_Queue* queue) :
