...
void NIRSBuffer::write(volatile uint8_t* source, size_t length) {
...
void NIRSBuffer::increment_and_check_push() {
...
void NIRSBuffer::reset_buffer(volatile BufferHelper<uint8_t>* buff) {
    *(buff->count_ptr) = 0;
    *(buff->time_ptr) = 0;
