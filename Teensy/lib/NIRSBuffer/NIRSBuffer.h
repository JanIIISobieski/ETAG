...
#include "Logger.h"
extern TimingData pressure_buffer_push;
...
class NIRSBuffer : public AbstractBuffer<uint8_t> {
    public:
        NIRSBuffer(volatile uint8_t** buffers, size_t num_buffers, size_t buffer_length, uint8_t id, Tag_Queue* queue) :
        ...
        volatile uint8_t* get_current_buffer() { return buffers[buffer_selector].head_ptr; }
